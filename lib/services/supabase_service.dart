...
class SupabaseService {
  ...
  static Future<UserModel?> createUser({
    ...
    try {
      // Use a temporary non-persistent client to sign up the new user
      // so it does not affect the currently logged in admin/teacher session.
      final tempClient = SupabaseClient(_projectUrl, _anonKey);
